...
-- GĐ3-04 dùng schema tích hợp tương thích GĐ3-03 CommitService và GĐ2-03 Rule Engine.
-- Business Rule chỉ được lưu YES/NO. CHUA_XAC_DINH là kết quả dẫn xuất khi không có rule phù hợp.
